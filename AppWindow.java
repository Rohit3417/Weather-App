...
public class AppWindow {
    ...
    static public void BuildUI() {
        ...
        search.addActionListener(e -> {
            ...
            new SwingWorker<WeatherRecord, Void>() {
                @Override
                // Runs on BACKGROUND thread — do heavy work here
                protected WeatherRecord doInBackground() {
                    WeatherRecord loc = CoordinateFetcher.getLocation(CityName.getText());
                    return loc != null ? WeatherFetcher.getWeather(loc) : null;
                }
